...
export default function StudioScreen() {
    ...
    return (
        ...
        >
            <View className="px-6" style={{ paddingTop: Math.max(insets.top, 20) }}>
                ...
                <View className="flex-row items-center mb-8">
                    ...
                    <View>
                        <Text className="text-[10px] font-black uppercase tracking-[3px]" style={{ color: theme.primary }}>
                            Creative Hub
                        </Text>
                        <Text className="text-4xl font-black tracking-tight" style={{ color: theme.text }}>
                            Studio
                        </Text>
                    </View>
                </View>
                ...
                {/* Intro Text */}
                <Text className="text-lg leading-relaxed mb-8 font-medium" style={{ color: theme.mutedText }}>
