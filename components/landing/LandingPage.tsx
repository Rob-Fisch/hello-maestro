        ...
        <View className="flex-1 bg-slate-950">
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
                        ...
                        <View className="flex-row flex-wrap justify-center gap-4 w-full px-4">
                            ...
                            <TouchableOpacity
                                onPress={() => {
                                    ...
                                    // For now just alert or open demo video
                                }}
                                className="bg-white/5 border border-white/10 px-8 py-4 rounded-full w-full md:w-auto items-center"
                            >
                                <Text className="text-slate-300 font-bold text-lg">See How It Works</Text>
                            </TouchableOpacity>
                        </View>
                    </Animated.View>
                </View>
                ...
                <View className="px-4 md:px-12 mb-32 items-center">
                    <View className={`w-full max-w-5xl aspect-[16/9] bg-slate-900 rounded-3xl border border-slate-700 overflow-hidden shadow-2xl shadow-indigo-900/40 relative`}>
                        {/* Glow */}
